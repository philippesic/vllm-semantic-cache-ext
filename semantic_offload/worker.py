...
class SemanticOffloadingWorker(CPUOffloadingWorker):
    def __init__(
        ...
        # DIAGNOSTIC REVERT (branch diagnose-stack-rebuild-revert): temporarily
        # restored to the pre-incremental full-rebuild design to isolate
        # whether the incremental stack_rebuild fix (557467b) is the cause of
        # a real B200 needle-v2 regression found tonight. Not for merging.
